...
const serviceAccount = require('./webflow-to-github_firebase-key.json');
admin.initializeApp({
...
// Serve the HTML form for adding a repository
app.get('/add-repository', (req, res) => {
    res.sendFile(path.join(__dirname, 'add-repository.html'));
});
